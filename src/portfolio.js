...
const greeting = {
  ...
  logo_path: "kas.png",
  nickname: "Ingénieur développeur Web, Data & IA",
  subTitle:
    "Passionné par programmation, les sciences des données et l'intelligence artificiel, qui s'efforce toujours de travailler sur des produits complets qui développent des systèmes innovants, techniques durables et évolutifs afin de créer un impact.",
  resumeLink:
    "https://drive.google.com/file/d/1pPMt37bQwiIM5UI4nx0yvz-hy8Wdejrt/view?usp=sharing",
  ...
  sections: [
    {
      ...
      experiences: [
        {
          title: "Ingénieur  développeur Web et Intelligence Artificiel",
          company: "Actemium",
